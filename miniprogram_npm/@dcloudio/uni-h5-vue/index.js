...
__DEFINE__(1660207800641, function(require, module, exports) {
...
function injectHook(type, hook, target = currentInstance, prepend = false) {
    if (target) {
        // fixed by xxxxxx
        if (uniShared.isRootHook(type) && target.$pageInstance) {
            // 系统保留组件，如 view,app 等
...
return __REQUIRE__(1660207800641);
})()
//miniprogram-npm-outsideDeps=["@vue/shared","@dcloudio/uni-shared"]
