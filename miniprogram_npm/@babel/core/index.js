...
__DEFINE__(1660207800250, function(require, module, exports) {
...
}, function(modId) {var map = {"./transformation/file/file":1660207800251,"./tools/build-external-helpers":1660207800252,"./config/files":1660207800253,"./config/helpers/environment":1660207800268,"./config":1660207800269,"./transform":1660207800283,"./transform-file":1660207800294,"./transform-ast":1660207800295,"./parse":1660207800296}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800251, function(require, module, exports) {
...
__DEFINE__(1660207800252, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../transformation/file/file":1660207800251}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800253, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./package":1660207800254,"./configuration":1660207800260,"./plugins":1660207800265}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800254, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./utils":1660207800255}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800255, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../caching":1660207800256,"../../gensync-utils/fs":1660207800259}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800256, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../gensync-utils/async":1660207800257,"./util":1660207800258}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800257, function(require, module, exports) {
...
__DEFINE__(1660207800258, function(require, module, exports) {
...
__DEFINE__(1660207800259, function(require, module, exports) {
...
exports.stat = stat;
0 && 0;
}, function(modId) { var map = {"fs":1660207800259}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800260, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../caching":1660207800256,"../helpers/config-api":1660207800261,"./utils":1660207800255,"./module-types":1660207800263,"../pattern-to-regex":1660207800264,"../../gensync-utils/fs":1660207800259}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800261, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../../":1660207800250,"../caching":1660207800256,"../cache-contexts":1660207800262}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800262, function(require, module, exports) {
0 && 0;
}, function(modId) { var map = {}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800263, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../../gensync-utils/async":1660207800257}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800264, function(require, module, exports) {
...
__DEFINE__(1660207800265, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../../gensync-utils/async":1660207800257,"./module-types":1660207800263,"./import-meta-resolve":1660207800266}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800266, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../../vendor/import-meta-resolve":1660207800267}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800267, function(require, module, exports) {
...
__DEFINE__(1660207800268, function(require, module, exports) {
...
__DEFINE__(1660207800269, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./full":1660207800270,"./partial":1660207800282,"./item":1660207800273}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800270, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../gensync-utils/async":1660207800257,"./util":1660207800258,"../index":1660207800250,"./plugin":1660207800271,"./item":1660207800273,"./config-chain":1660207800276,"./helpers/deep-array":1660207800272,"./caching":1660207800256,"./validation/options":1660207800277,"./validation/plugins":1660207800281,"./helpers/config-api":1660207800261,"./partial":1660207800282,"./cache-contexts":1660207800262}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800271, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./helpers/deep-array":1660207800272}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800272, function(require, module, exports) {
...
__DEFINE__(1660207800273, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./config-descriptors":1660207800274}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800274, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./files":1660207800253,"./item":1660207800273,"./caching":1660207800256,"./resolve-targets":1660207800275}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800275, function(require, module, exports) {
...
__DEFINE__(1660207800276, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./validation/options":1660207800277,"./pattern-to-regex":1660207800264,"./printer":1660207800280,"./files":1660207800253,"./caching":1660207800256,"./config-descriptors":1660207800274}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800277, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../plugin":1660207800271,"./removed":1660207800278,"./option-assertions":1660207800279}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800278, function(require, module, exports) {
...
__DEFINE__(1660207800279, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./options":1660207800277}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800280, function(require, module, exports) {
...
__DEFINE__(1660207800281, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./option-assertions":1660207800279}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800282, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./plugin":1660207800271,"./util":1660207800258,"./item":1660207800273,"./config-chain":1660207800276,"./helpers/environment":1660207800268,"./validation/options":1660207800277,"./files":1660207800253,"./resolve-targets":1660207800275}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800283, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./config":1660207800269,"./transformation":1660207800284}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800284, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./plugin-pass":1660207800285,"./block-hoist-plugin":1660207800286,"./normalize-opts":1660207800287,"./normalize-file":1660207800288,"./file/generate":1660207800292,"../config/helpers/deep-array":1660207800272}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800285, function(require, module, exports) {
...
__DEFINE__(1660207800286, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"../config/plugin":1660207800271}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800287, function(require, module, exports) {
...
__DEFINE__(1660207800288, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./file/file":1660207800251,"../parser":1660207800289,"./util/clone-deep":1660207800291}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800289, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./util/missing-plugin-helper":1660207800290}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800290, function(require, module, exports) {
...
__DEFINE__(1660207800291, function(require, module, exports) {
...
__DEFINE__(1660207800292, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./merge-map":1660207800293}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800293, function(require, module, exports) {
...
__DEFINE__(1660207800294, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./config":1660207800269,"./transformation":1660207800284,"./gensync-utils/fs":1660207800259}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1660207800295, function(require, module, exports) {
...
__DEFINE__(1660207800296, function(require, module, exports) {
...
0 && 0;
}, function(modId) { var map = {"./config":1660207800269,"./parser":1660207800289,"./transformation/normalize-opts":1660207800287}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1660207800250);
})()
//miniprogram-npm-outsideDeps=["@babel/types","@babel/parser","@babel/traverse","@babel/template","@babel/helpers","@babel/code-frame","@babel/helper-module-transforms","semver","@babel/generator","gensync","path","fs","debug","json5","module","url","./import.cjs","assert","util","@babel/helper-compilation-targets","convert-source-map","@ampproject/remapping"]
